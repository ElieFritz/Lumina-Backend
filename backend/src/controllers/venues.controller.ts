...
export class VenuesController {
  ...
  getVenueById(@Param('id') id: string) {
    const venue = this.mockVenues.find(v => v.id === parseInt(id));
  ...
  getVenuesByCategory(@Param('category') category: string) {
    const venues = this.mockVenues.filter(venue => venue.category === category);
